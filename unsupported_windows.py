...
def main():
    ...
    msg_is_from = "grssocteam@fujitsu.com"
    msg_is_to = (
        "jg.alcayaga@fujitsu.com", 
        "kimdio.apelo@fujitsu.com",
        "christianalvin.fadera@fujitsu.com",
        "r.gequillana@fujitsu.com",
        "marvin.mia@fujitsu.com",
        "h.ramalan@fujitsu.com",
        "rt.santiago@fujitsu.com",
        "r.toyonaga@fujitsu.com",
        "a.ybiernas@fujitsu.com")
    # send_email_g09(msg_is_from,msg_is_to)
    # send_email_g08(msg_is_from,msg_is_to)
    # send_email_g07(msg_is_from,msg_is_to)
    # send_email_g06(msg_is_from,msg_is_to)
    # send_email_g05(msg_is_from,msg_is_to)
    # send_email_g02(msg_is_from,msg_is_to)

    for x in msg_is_to:
            send_email_g09(msg_is_from,x)
            send_email_g07(msg_is_from,x)
            send_email_g08(msg_is_from,x)
            send_email_g06(msg_is_from,x)
            send_email_g05(msg_is_from,x)
            send_email_g02(msg_is_from,x)
