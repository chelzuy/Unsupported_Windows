...
def send_email_r01(msg_from, msg_to):
    ...
    if r01 != []:
        try:
            server = smtplib.SMTP('webmail.domain.local')
            server.sendmail(msg_from, msg_to, msg.as_string())
        except SMTPException:
...
def main():
    ...
    send_email_g09("msg_from@domain.com", "msg_to@domain.com")
    send_email_g08("msg_from@domain.com", "msg_to@domain.com")
    send_email_g07("msg_from@domain.com", "msg_to@domain.com")
    send_email_g06("msg_from@domain.com", "msg_to@domain.com")
    send_email_g05("msg_from@domain.com", "msg_to@domain.com")
    send_email_g02("msg_from@domain.com", "msg_to@domain.com")
